...
```bash
python3 "${CLAUDE_PLUGIN_ROOT}/skills/install_from_vid/extract.py" "<URL>" "<scratchpad>/vid"
```
...
```bash
python3 "${CLAUDE_PLUGIN_ROOT}/skills/install_from_vid/extract.py" "<URL>" "<scratchpad>/vid" --frames
```
